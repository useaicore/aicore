...
export default function FourPillars() {
  return (
    <section id="features" className="relative overflow-hidden">
      {/* Shifting gradient behind the full section */}
      <div
      ...
      <div className="relative py-28 max-w-[1100px] mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-[var(--text-primary)] leading-tight mb-4">
            ...
            <a
              href="#"
              className="text-[var(--gold-mid)] text-sm font-semibold hover:text-[var(--gold-bright)] transition-colors duration-150"
            >
          ...
          <div className="flex-1 min-w-0 w-full max-w-[480px]">
            <div className="glass rounded-xl overflow-hidden glow-gold">
              ...
              <div className="p-5 font-mono text-[13px] space-y-1.5">
                ...
                <div className="text-[var(--gold-bright)] text-[12px]">
                  {'  [████████████████████]'} done
                </div>
                <div className="h-1" />
      ...
      <div className="relative py-28 max-w-[1100px] mx-auto px-6">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 70% 50% at 80% 50%, rgba(74,143,170,0.05) 0%, transparent 70%)',
          }}
        />
        ...
        <div className="relative flex flex-col lg:flex-row-reverse gap-16 lg:gap-24 items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[var(--text-secondary)] text-base leading-relaxed mb-4 max-w-[420px]">
              A full project read is 28,000 tokens of raw file content. Too
              expensive. Too slow. Too much noise.
            </p>
            <p className="text-[var(--text-secondary)] text-base leading-relaxed mb-4 max-w-[420px]">
              The Context Engine compresses it to 400 tokens of structured,
              semantic context — stack, deps, patterns, providers.
            </p>
            <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-6 max-w-[420px]">
              Generated once during init. Injected automatically on every
              session. Permanent savings — not just the first call.
            </p>
            <a
              href="#"
              className="text-[var(--sky-mid)] text-sm font-semibold hover:text-[var(--sky-bright)] transition-colors duration-150"
            >
          ...
          {/* Compression visual */}
          <div className="flex-1 min-w-0 w-full max-w-[480px] space-y-4">
            {/* Main stat card */}
            ...
            <div className="glass-neutral rounded-xl p-4 font-mono text-[12px]">
              <div className="text-[var(--text-faint)] text-[10px] uppercase tracking-widest mb-3">
      ...
      <div className="relative py-28 max-w-[1100px] mx-auto px-6">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 70% 50% at 20% 50%, rgba(212,168,50,0.04) 0%, transparent 70%)',
          }}
        />
        ...
        <div className="relative flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          ...
          <div className="flex-1 min-w-0 lg:pt-2">
            ...
            <p className="text-[var(--text-secondary)] text-base leading-relaxed mb-4 max-w-[400px]">
              Circuit breaker. Latency routing. Quality scoring. Automatic
              failover. The proxy that actually thinks — not just a URL swap.
            </p>
            ...
            <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-6 max-w-[400px]">
              Run GPT-4o. Shadow it with Claude. Compare costs and quality for
              2 weeks. Switch when you&apos;re confident. Zero risk. Real data.
            </p>
            <a
              href="#"
              className="text-[var(--gold-mid)] text-sm font-semibold hover:text-[var(--gold-bright)] transition-colors duration-150"
          ...
          {/* Right: YAML + shadow mode split panel */}
          <div className="flex-1 min-w-0 w-full max-w-[500px] space-y-4">
            ...
            <div className="glass rounded-xl overflow-hidden">
              ...
              <div className="p-5 font-mono text-[12px] leading-[1.75]">
                <div>
                  <span className="text-[var(--sky-bright)]">routing</span>
                  <span className="text-[var(--text-secondary)]">:</span>
                </div>
                <div className="pl-4">
                  <span className="text-[var(--sky-mid)]">primary</span>
                  <span className="text-[var(--text-secondary)]">: </span>
                  <span className="text-[var(--gold-cream)]">gpt-4o</span>
                </div>
                <div className="pl-4">
                  <span className="text-[var(--sky-mid)]">fallback</span>
                  <span className="text-[var(--text-secondary)]">: </span>
                  <span className="text-[var(--gold-cream)]">claude-3-5-sonnet</span>
                </div>
                <div className="pl-4 mt-0.5">
                  <span className="text-[var(--sky-bright)]">shadow</span>
                  <span className="text-[var(--text-secondary)]">:</span>
                </div>
                <div className="pl-8">
                  <span className="text-[var(--sky-mid)]">enabled</span>
                  <span className="text-[var(--text-secondary)]">: </span>
                  <span className="text-[var(--success)]">true</span>
                </div>
                <div className="pl-8">
                  <span className="text-[var(--sky-mid)]">target</span>
                  <span className="text-[var(--text-secondary)]">: </span>
                  <span className="text-[var(--gold-cream)]">claude-3-5-sonnet</span>
                </div>
                <div className="pl-4 mt-0.5">
                  <span className="text-[var(--sky-mid)]">latencyThreshold</span>
                  <span className="text-[var(--text-secondary)]">: </span>
                  <span className="text-[var(--gold-cream)]">2000</span>
                </div>
                <div className="pl-4">
                  <span className="text-[var(--sky-bright)]">circuitBreaker</span>
                  <span className="text-[var(--text-secondary)]">:</span>
                </div>
                <div className="pl-8">
                  <span className="text-[var(--sky-mid)]">threshold</span>
                  <span className="text-[var(--text-secondary)]">: </span>
                  <span className="text-[var(--gold-cream)]">5</span>
                </div>
                <div className="pl-8">
                  <span className="text-[var(--sky-mid)]">window</span>
                  <span className="text-[var(--text-secondary)]">: </span>
                  <span className="text-[var(--gold-cream)]">60s</span>
                </div>
              </div>
            </div>

            {/* ── Shadow mode split panel — THE FEATURE MOMENT ── */}
                ...
                <div className="glass-sky p-4 space-y-2.5">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-[10px] text-[var(--sky-dim)] flex items-center gap-1">
                      <span className="w-1.5 h-1.5 rounded-full bg-[var(--sky-dim)] inline-block" />
                      silent
                    </span>
                  </div>
                  {shadowRows.map(row => (
      ...
      <div className="relative py-28 max-w-[1100px] mx-auto px-6">
        <div className="flex flex-col lg:flex-row-reverse gap-16 lg:gap-24 items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[var(--text-secondary)] text-base leading-relaxed mb-4 max-w-[420px]">
              Replace five provider keys with one. Route to any model. Every
              call logged with provider, model, tokens, cost, and latency.
            </p>
            <p className="text-[var(--text-muted)] text-sm leading-relaxed mb-6 max-w-[420px]">
              Change your{' '}
              <code className="text-[var(--sky-mid)] font-mono text-xs bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded">
                baseURL
              </code>{' '}
              to{' '}
              <code className="text-[var(--sky-mid)] font-mono text-xs bg-[var(--bg-elevated)] px-1.5 py-0.5 rounded">
              ...
              . Everything else stays the same — your SDK, your prompts, your retry logic.
            </p>
            <a
              href="#"
              className="text-[var(--sky-mid)] text-sm font-semibold hover:text-[var(--sky-bright)] transition-colors duration-150"
            ...
            <div className="glass-sky rounded-xl overflow-hidden">
              ...
              <div className="grid grid-cols-[1fr,72px,64px,68px,40px] gap-2 px-4 py-3 border-b border-[rgba(74,143,170,0.15)] bg-[rgba(0,0,0,0.3)]">
                {['Model', 'Latency', 'Tokens', 'Cost', ''].map((h, i) => (
                  <div key={i} className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-faint)]">
                    {h}
                  </div>
                ))}
              </div>
              ...
              {logRows.map((row, i) => (
                <div
                  key={i}
                  className={`grid grid-cols-[1fr,72px,64px,68px,40px] gap-2 px-4 py-3 border-b border-[rgba(74,143,170,0.05)] font-mono text-[12px] transition-colors duration-150 ${
                    row.ok
                      ? 'hover:bg-[rgba(212,168,50,0.04)]'
                      : 'bg-[rgba(160,80,64,0.07)] border-l-2 border-l-[var(--error)]'
                  }`}
                >
                  ...
                  <span className={row.ok ? 'text-[var(--success)]' : 'text-[var(--error)]'}>
                    {row.ok ? '✓' : '✗'}
                  </span>
                </div>
              ))}
