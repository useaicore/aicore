const stats = [
  {
    ...
    sub: '28,419 → 402 tokens',
  },
  {
    value: '<1ms',
    label: 'Injection overhead',
    sub: 'reads from disk, not network',
  },
  {
    value: '∞',
    label: 'Sessions saved',
    sub: 'generated once, used forever',
  },
  {
    value: '$0',
    label: 'Cold-start cost',
    sub: 'no LLM call during init',
  },
];
  ...
  return (
    <section className="relative py-28 overflow-hidden section-sky-ambient">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% 50%, rgba(74,143,170,0.06) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative max-w-[1100px] mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-[var(--text-primary)] mb-5 leading-tight">
            Change one line.<br />
        ...
        {/* 4-stat strip with animated gradient border */}
        <div className="spin-border-wrap rounded-xl mb-14">
          ...
          <div className="relative rounded-[11px] glass grid grid-cols-2 md:grid-cols-4">
            {stats.map((s, i) => (
              <div
                key={i}
                className={`p-8 text-center ${i < stats.length - 1 ? 'border-r border-[rgba(255,255,255,0.05)]' : ''} ${i === 1 ? 'border-b md:border-b-0' : ''}`}
              >
                <div className="text-3xl md:text-4xl font-black text-[var(--sky-bright)] mb-2">
                  {s.value}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="glass rounded-xl overflow-hidden">
            ...
            <div className="p-5 font-mono text-[12px] leading-[1.8]">
              <div>
                <span className="text-[var(--sky-bright)]">import</span>
                {' OpenAI '}
              ...
              <div className="h-3" />
              <div>
                <span className="text-[var(--sky-bright)]">const</span>
                {' client = '}
                <span className="text-[var(--sky-bright)]">new</span>
                {' OpenAI({'}
              </div>
          ...
          {/* After */}
          <div className="glass-sky rounded-xl overflow-hidden glow-sky">
            ...
            <div className="p-5 font-mono text-[12px] leading-[1.8]">
              ...
              <div className="bg-[rgba(107,158,94,0.1)] border-l-2 border-[var(--success)] -mx-5 px-5">
